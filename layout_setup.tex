...
% 国赛层级：一级四号黑体 > 二级小四黑体 > 正文小四宋体 > 图题/表题/表头五号。
% 模板把图题表题设成小四加粗，表内又常跟正文同字号，表头会看起来比小节标题更大。
\DeclareCaptionFont{fivehao}{\zihao{5}\songti}
\captionsetup[figure]{font={fivehao},labelfont=fivehao,textfont=fivehao}
\captionsetup[table]{font={fivehao},labelfont=fivehao,textfont=fivehao}
\captionsetup[subtable]{font=fivehao}
\captionsetup[subfigure]{font=fivehao}
